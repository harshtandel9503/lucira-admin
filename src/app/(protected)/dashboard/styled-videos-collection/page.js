    ...
    <div className='max-w-7xl mx-auto py-10 px-8'>
      <div className='flex flex-col md:flex-row md:items-center justify-between mb-10 gap-6'>
        <div className="min-w-0">
          <h1 className='admin-title'>Styled Video Collection Specific</h1>
          <p className="admin-subtitle">Manage collection-specific videos and tagged products.</p>
        </div>
                ...
                <div className='flex-1 space-y-8'>
                  <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
                    <div className='space-y-3'>
                      <label className='text-[10px] font-bold uppercase tracking-widest text-ink-muted flex items-center gap-2'><Video size={12} /> SHOPIFY VIDEO URL</label>
                      <input value={video.video || ''} onChange={e => updateVideoUrl(vIndex, e.target.value)} className='w-full px-5 py-3.5 bg-panel-alt border border-hairline-soft rounded-[8px] text-sm focus:outline-none focus:ring-2 focus:ring-black' placeholder='Paste Shopify CDN URL here...' />
                    </div>
                    <div className='space-y-3'>
                      <label className='text-[10px] font-bold uppercase tracking-widest text-ink-muted flex items-center gap-2'><Layers size={12} /> COLLECTION HANDLE</label>
                      <input value={video.collectionHandle || ''} onChange={e => updateCollectionHandle(vIndex, e.target.value)} className='w-full px-5 py-3.5 bg-panel-alt border border-hairline-soft rounded-[8px] text-sm focus:outline-none focus:ring-2 focus:ring-black' placeholder='e.g. hexa, rings, etc.' />
                    </div>
                  </div>
